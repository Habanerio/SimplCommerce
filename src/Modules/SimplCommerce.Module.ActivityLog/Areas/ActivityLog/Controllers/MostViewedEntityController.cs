...
public class MostViewedEntityController : Controller
{
    ...
    public async Task<IList<MostViewEntityDto>> GetMostViewedEntities(string entityTypeId, CancellationToken token = default)
    {
        return await _activityTypeRepository.List()
